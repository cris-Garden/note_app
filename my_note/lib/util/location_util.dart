...
class LocationUtil {
  ...
  static final LocationUtil _util = LocationUtil._internal();
...
class ChineseCupertinoLocalizations implements CupertinoLocalizations {
  ...
  Future init() async {
    ml = await materialDelegate.load(LocationUtil().deviceLocal);
...
class _ChineseDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  ...
  bool isSupported(Locale locale) {
    return locale.languageCode == 'zh' || locale.languageCode == 'ja' || locale.languageCode == 'en';
  }
